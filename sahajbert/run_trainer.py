...
from dataset_streaming import make_lazy_wikioscar_dataset
...
def main():
    ...
    tokenized_datasets = make_lazy_wikioscar_dataset(
        tokenizer=tokenizer, shuffle_seed=hash(local_public_key) % 2 ** 31
    )
